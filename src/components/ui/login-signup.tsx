...
import { Mail, Lock, Eye, EyeOff, ShieldCheck, AlertTriangle, X } from "lucide-react";
  ...
  return (
    <section className="fixed inset-0 bg-zinc-950 text-zinc-50 overflow-hidden flex items-center justify-center font-sans">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute -bottom-45 -right-45 w-[600px] h-[600px] rounded-full bg-blue-600/10 blur-[120px]" />
      </div>
      ...
      {/* Sliding Warning Pop-up message */}
      ...
      <div className="w-full max-w-md px-4 z-10">
        {!success ? (
          <div className="relative w-full rounded-2xl border border-zinc-800/80 bg-zinc-900/60 backdrop-blur-xl shadow-[0_25px_60px_-15px_rgba(0,0,0,0.7)] hover:border-zinc-700/60 transition-colors duration-300">
          ...
          /* Static Success entry sequence */
          <div className="w-full py-16 flex flex-col items-center justify-center bg-zinc-900/60 border border-violet-500/30 rounded-2xl backdrop-blur-xl shadow-2xl text-center">
            <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-violet-600 to-indigo-600 flex items-center justify-center shadow-lg shadow-violet-500/30 mb-6">
